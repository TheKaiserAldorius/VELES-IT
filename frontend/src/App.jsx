...
const ServiceCard = ({ service }) => (
  <div className="service-card1"> {/* Изменили класс */}
...
const ProjectCard = ({ project }) => (
  <div className="case-card">
    <div className="case-image" style={{ backgroundImage: `url(${project.image})` }}></div>
  ...
  const services = [
    {
      ...
      description: "Разработка AI-решений для автоматизации бизнес-процессов, чат-боты и нейросети",
      price: "от 150 000 ₽",
    ...
    },
    {
      ...
      description: "Комплексное продвижение в социальных сетях с креативным подходом",
      price: "от 50 000 ₽",
      image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80",
      path: "/smm"
    },
    ...
    <div className="services-grid1">
      ...
      <section className="cases-section">
        <div className="section-container">
          <h2>Наши проекты</h2>
          <p className="section-subtitle">Реализованные решения с измеримыми результатами</p>
      ...
      <section className="team-section">
        <div className="section-container">
          <h2>Наша команда</h2>
          <p className="section-subtitle">Профессионалы с опытом реализации сложных проектов</p>
        ...
        <div className="section-container">
          <div className="contact-container">
            <div className="contact-info">
              ...
              <p><span>📧 Email:</span> info@velesit.pro</p>
              <p><span>📞 Телефон:</span> +7 926 912 8783</p>
              <p><span>🏢 Адрес:</span>123376, г. Москва, ул. Красная Пресня, д. 32-34, пом. 1Л/Н</p>
