  ...
  const aiCases = [
    {
      ...
      solution: "Разработали систему на базе NLP для автоматической классификации и обработки 5000+ документов ежедневно",
    ...
    },
    {
      ...
      solution: "Внедрили ИИ-систему для автоматического создания персонализированных видео-отчетов для клиентов",
      result: "Увеличение вовлеченности на 45%, сокращение затрат на производство",
      icon: "🎥"
    },
    {
      id: 3,
      ...
      solution: "Разработали систему предиктивной аналитики для прогнозирования покупок и персонализации предложений",
    ...
    },
    {
      ...
      solution: "Создали интеллектуального ассистента для обработки запросов клиентов 24/7",
      ...
      <section className="cyber-hero">
        <div className="container">
          ...
          <p className="subtitle">
            Внедряем передовые AI-технологии для автоматизации процессов, анализа данных и улучшения клиентского опыта
          </p>
      ...
      <section className="cyber-services">
        <div className="container">
          ...
          <p className="section-description">
            Реальные примеры реализации искусственного интеллекта для решения бизнес-задач
          </p>
          ...
          <div className="services-grid">
            {aiCases.map((caseItem) => (
              <div 
                key={caseItem.id} 
                className={`service-card ${activeCase === caseItem.id ? 'active' : ''}`}
        ...
        <div className="container">
          ...
          <div className="levels-container">
            ...
            <div className="level">
              ...
              <p>Анализ и генерация текста, чат-боты, классификация документов</p>
            </div>
            <div className="level">
          ...
          <div className="cta-content">
            <div className="cta-text">
              ...
              <div className="cta-contacts">
                ...
                <p>Email: <span>ai@cyberdev.ru</span></p>
              </div>
            </div>
            <form className="cta-form">
              ...
              <button type="submit" className="cyber-button">Отправить запрос</button>
            </form>
          </div>
        </div>
      </section>
