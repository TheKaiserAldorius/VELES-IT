...
const DesignPage = () => {
  ...
  const faqs = [
    {
      ...
      answer: "Стоимость зависит от сложности проекта. Дизайн лендинга - от 30 000 руб., интернет-магазина - от 60 000 руб."
    },
    {
      id: 2,
  ...
  const getActiveDesigns = () => {
    switch(activeTab) {
      case 'web': return webDesigns;
      case 'mobile': return mobileDesigns;
      case 'branding': return brandingDesigns;
      default: return webDesigns;
    }
  };
    ...
    <div className="design-page">
      ...
      <section className="design-hero">
        <div className="container">
          ...
          <p className="design-subtitle">Создаем запоминающиеся визуальные решения для вашего бизнеса</p>
