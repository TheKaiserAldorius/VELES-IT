...
const SEOPage = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert(
      `Спасибо, ${formData.name}! Наш SEO-специалист свяжется с вами для анализа сайта ${formData.website}`
    );
    setFormData({
      name: "",
      email: "",
  ...
  const faqData = [
    {
      ...
      answer:
        "Первые результаты обычно видны через 3-4 месяца, но выход в ТОП по конкурентным запросам может занять 6-12 месяцев. Мы даем прогноз после аудита вашего сайта.",
    },
    {
      question: "Какие методы SEO вы используете?",
      answer:
        "Только белые методы: оптимизация контента и структуры, улучшение юзабилити, наращивание качественных ссылок, работа с поведенческими факторами.",
    },
    {
      question: "Нужно ли платить за размещение в поисковиках?",
      answer:
        "Нет, органическое SEO не требует оплаты за размещение. Вы платите только за работу специалистов по оптимизации.",
    },
    {
      question: "Как часто нужно обновлять контент?",
      answer:
        "Рекомендуем обновлять ключевые страницы каждые 6-12 месяцев, блог - 2-4 раза в месяц. Частота зависит от тематики и конкурентности.",
    },
    {
      question: "Что важнее: SEO или контекстная реклама?",
      answer:
        "Оба инструмента важны. Реклама дает быстрый трафик, SEO - стабильный долгосрочный результат. Оптимально использовать оба подхода.",
    },
  ];
  ...
  const services = [
    {
      title: "SEO-аудит",
      description:
        "Полный анализ сайта и выявление ошибок, мешающих продвижению",
      icon: "🔍",
    },
    {
      title: "Техническое SEO",
      description:
        "Оптимизация скорости, мобильной версии, индексации и структуры",
      icon: "⚙️",
    },
    {
    ...
    },
    {
      title: "Локальное SEO",
      description:
        "Продвижение для местного бизнеса в Google Maps и Яндекс.Картах",
      icon: "📍",
    },
    {
      title: "SEO-аналитика",
  ...
  return (
    <div className="cyber-page">
      <SEO
        title="SEO продвижение | Veles IT"
        description="Veles IT: профессиональное SEO-продвижение сайтов. Увеличим органический трафик и продажи. SEO-аудит, техническое SEO, контент-маркетинг, линкбилдинг."
        keywords="Veles IT, seo, seo продвижение, поисковая оптимизация, seo аудит, оптимизация сайта, раскрутка сайта, линкбилдинг, контент-маркетинг"
      />
      {/* Hero Section */}
        ...
        <div className="container">
          <div className="cta-content">
            <div className="cta-text">
              ...
              <p>
                Оставьте заявку и получите бесплатный аудит вашего сайта с
                планом оптимизации
              </p>
              <div className="cta-contacts">
                ...
                <p>
                  Email: <span>seo@cyberdev.ru</span>
                </p>
              </div>
            </div>
