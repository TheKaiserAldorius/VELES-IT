...
const DevPage = () => {
  ...
  const services = [
    {
      ...
      description: "Производим одностраничные сайты для презентации продуктов или услуг",
      icon: "🖥️"
    },
    {
      id: 2,
      title: "Интернет-магазины",
      description: "Разрабатываем платформы для онлайн-продаж с удобным каталогом и системой оплаты",
      icon: "🛒"
    },
    {
      id: 3,
      title: "Корпоративные сайты",
      description: "Создаём представительства компаний в интернете, которые повышают доверие клиентов",
      icon: "🏢"
    },
    {
      id: 4,
      title: "Веб-приложения",
      description: "Разрабатываем сложные интерактивные решения для специфических задач вашего бизнеса",
      icon: "⚙️"
    }
  ];
  ...
  const advantages = [
    {
      id: 1,
      title: "Уникальность",
      description: "Разрабатываем исключительные решения, учитывая специфику вашего бизнеса",
      icon: "✨"
    },
    {
      id: 2,
  ...
  const steps = [
    { id: 1, title: "Анализ и планирование", description: "Изучаем ваш бизнес, определяем цели" },
    { id: 2, title: "Проектирование", description: "Создаём прототипы и структуру сайта" },
    { id: 3, title: "Дизайн", description: "Разрабатываем уникальный визуальный стиль" },
    { id: 4, title: "Разработка", description: "Программируем функционал и интегрируем сервисы" },
    { id: 5, title: "Тестирование", description: "Проверяем работу на различных устройствах" },
    { id: 6, title: "Запуск и поддержка", description: "Размещаем сайт и обеспечиваем работу" }
  ];
      ...
      <section className="cyber-hero">
        <div className="container">
          ...
          <p className="subtitle">
            Создаём современные и эффективные веб-решения, которые помогают вашему бизнесу расти
          </p>
          ...
          <div className="cta-content">
            <div className="cta-text">
              ...
              <div className="cta-contacts">
                <p>Телефон: <span>+7 (495) 123-45-67</span></p>
                <p>Email: <span>dev@cyberdev.ru</span></p>
              </div>
            </div>
